...
# Task  
1. The review-2 agent checks sources in the combined output `combined-answers.md`, and all information has cited sources.  

# Guardrails  
1. Check all of the information in the combined output, before checking individual sentences.  
2. Treat all sentences as fabricated, until verified or partially verified.  
...
2. In the `combined-answers.md` file, add a note to say "✅ Review-2 (sources) completed."  
